...
<!--
[xsl_transform xsl_file="qa/util-super-global.xsl"]
<TESTS>
  <TEST>
    <global>_SERVER</global>
    <index>DOCUMENT_ROOT</index>
    <expected><RESULT global="_SERVER" index="DOCUMENT_ROOT">/srv/www.tenandtwo.io/htdocs</RESULT></expected>
  </TEST>
  <TEST>
    <global>_REQUEST</global>
    <expected><RESULT global="_REQUEST" index="" count="0"/></expected>
  </TEST>
  <TEST>
